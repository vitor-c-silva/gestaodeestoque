...
- Diminuição da perda de lucros.
- Maior controle de quando precisa comprar os ingredientes faltantes.
- Menos desperdício de materiais, já que agora sabe a quantidade exata que está usando, sem perder anotações pela casa ou bloco de notas.
- Agilidade para verificar quais produtos estão faltando ou estão prestes a acabar, assim também com os doces, já que não vai precisar procurar um por um para verificar qual falta ou está acabando.
